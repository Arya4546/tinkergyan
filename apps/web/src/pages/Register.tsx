      ...
      <div className="flex w-full max-w-[1400px] mx-auto hw-border-x hw-panel border-t-0 border-b-0 min-h-screen flex-row-reverse">
        ...
        <div className="flex w-full flex-col justify-center px-6 lg:w-[600px] border-l border-slate-900 dark:border-slate-800 shrink-0 bg-white dark:bg-[#111111] py-12">
          <div className="w-full max-w-sm mx-auto">
            ...
            <div className="mb-8">
              <span className="inline-block px-2 py-1 bg-emerald-500/10 text-emerald-500 border border-emerald-500/30 font-sans text-[10px] font-bold uppercase tracking-widest mb-4">
                New Account
              </span>
              ...
              <p className="font-sans text-xs text-slate-500 tracking-wide">
                ...
                <Link
                  to="/login"
                  className="text-emerald-500 hover:text-emerald-600 underline underline-offset-4 font-bold"
                >
                  Log in
                </Link>
              </p>
        ...
        <div className="hidden lg:flex flex-1 flex-col bg-dot-matrix p-10 justify-start items-start relative overflow-hidden">
          <div className="font-sans text-[10px] text-slate-400 uppercase tracking-widest text-left mb-auto">
            Tinkergyan v2.1
            <br />
            Ready for you
          </div>
